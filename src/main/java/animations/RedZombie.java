...
public class RedZombie extends Zombie {
    ...
    public void move_show(Graphics g) {
        g.drawImage((new ImageIcon(ImageConfig.redZombieFrame + page + ".png")).getImage(), x, y, null);
    }
    ...
    public void eat_show(Graphics g) {
        g.drawImage((new ImageIcon(ImageConfig.redZombieEatFrame + page + ".png")).getImage(), x, y, null);
